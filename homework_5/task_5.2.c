...
bool addNumberToSet(AVLTree* tree, int number)
{
    addValue(tree, number);
    return true;
}

bool removeNumberFromSet(AVLTree* tree, int number)
{
    removeValue(tree, number);
    return true;
}

bool isElementInSet(AVLTree* tree, int number)
{
...
bool printAllElements(AVLTree* tree)
{
    printTree(tree);
    return true;
}

void callFunction(AVLTree* tree, int functionNumber)
{
